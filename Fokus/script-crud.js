...
let tarefaSelecionada=null;
let liTarefaSelecionada = null
let tarefas = JSON.parse(localStorage.getItem('fokus')) || []//A lista de tarefas tenata encontrar primeiro os elementos JSON (vai tentar transformar os elementos JSON em strings, usando PARSE) salvos na localStorage, caso nao exista será uma array vazia

function atualizarTarefas(){
    localStorage.setItem('fokus', JSON.stringify(tarefas))
